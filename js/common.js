...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "img/"+stype+"/board.png";
...
com.args={
	//红子 中文/图片地址/阵营/权重
	'c':{text:"车", img:'rr', my:1 ,bl:"c", value:com.value.c},
	'm':{text:"马", img:'rn', my:1 ,bl:"m", value:com.value.m},
	'x':{text:"相", img:'rb', my:1 ,bl:"x", value:com.value.x},
	's':{text:"仕", img:'ra', my:1 ,bl:"s", value:com.value.s},
	'j':{text:"将", img:'rk', my:1 ,bl:"j", value:com.value.j},
	'p':{text:"炮", img:'rc', my:1 ,bl:"p", value:com.value.p},
	'z':{text:"兵", img:'rp', my:1 ,bl:"z", value:com.value.z},
	
	//黑子
	'C':{text:"�", img:'br', my:-1 ,bl:"c", value:com.value.C},
	'M':{text:"�R", img:'bn', my:-1 ,bl:"m", value:com.value.M},
	'X':{text:"象", img:'bb', my:-1 ,bl:"x", value:com.value.X},
	'S':{text:"士", img:'ba', my:-1 ,bl:"s", value:com.value.S},
	'J':{text:"帅", img:'bk', my:-1 ,bl:"j", value:com.value.J},
	'P':{text:"炮", img:'bc', my:-1 ,bl:"p", value:com.value.P},
	'Z':{text:"卒", img:'bp', my:-1 ,bl:"z", value:com.value.Z}
};
